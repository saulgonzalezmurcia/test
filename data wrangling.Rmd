...
---
```{r, loadLibraries}
# install packages preferbly in R instead of RStudio to have only one location for a package
# open R as an admin
...
Note that the `echo = FALSE` parameter was added to the code chunk to prevent printing of the R code that generated the plot.
 ...
 $$
```{r add chunks}
# this is a chunk, add it by clicking Insert and then R or by a shortcut: control = alt = i
# name your chunks!
```
